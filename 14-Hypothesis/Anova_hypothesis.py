# -*- coding: utf-8 -*-
"""
Created on Thu Jan 16 09:11:31 2025
...
#example:testing if theres a differnce in soft drink consumption between adults and children
#without assuming which group consumes more
#objective:there is a significant difference in soft drink consumption
#between adults and children
soft_drink=pd.read_excel("c:/14-Hypothesis/johnyTalkers.xlsx")
from statsmodel.stats.proportion import proportion_ztest


#Data preparation
count = np.array([58, 152])
nobs = np.array([488, 740]) 
#The two-proportion Z-test compares the proportions
#of two groups, Here:
    
#Count [58,152]: The number of successes
# (people consuming soft drinks) in each group

#nobs (480,740), The total number of observations
#in each group (total and children surveyed).
#The count and nobis values come from summarizing the data
#about the soft drink consumption for adults and children.
#Here's how these values are typically obtained:

#count: Represents the number of individuals in each group
